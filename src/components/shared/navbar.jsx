...
console.log(user,"user")
  ...
  window.location.href = "/login";
    ...
    (<div className='flex gap-3 sm:flex-col md:flex-row'><Link href="/login" className='focus:text-blue-500 hover:text-pink-500'>Log In</Link><span>or</span><Link href="/signup"  className='focus:text-blue-500 hover:text-pink-500'>Sign up</Link></div>)}
